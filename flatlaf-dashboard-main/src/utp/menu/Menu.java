...
import utp.menu.mode.LightDarkMode;
...
import utp.menu.mode.ToolBarAccentColor;
...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        ...
        {"Hospital CRUD", "Doctor","Paciente"},
        {"Chat"},
        {"Calendar"},
        {"~HISTORIAL MEDICO~"},
        {"Gestionar Historia Clínica", "Consultar Resultados de Exámenes"},
...
//        {"~GESTIÓN~"},
//        {"Gestión de Usuarios", "Gestión de Doctores", "Gestión de Pacientes"},
//        {"~REPORTES~"},
//        {"Generar Reportes", "Ver Estadísticas"},
//        {"Logout"}
//    };
//
//    // Menú para el rol de Doctor
//    private final String menuItemsDoctor[][] = {
//        {"~CONSULTAS~"},
//        {"Ver Citas", "Escribir Prescripciones"},
//        {"~HISTORIAL MÉDICO~"},
//        {"Gestionar Historia Clínica", "Consultar Resultados de Exámenes"},
//        {"Logout"}
//    };
//
//    // Menú para el rol de Paciente
//    private final String menuItemsPaciente[][] = {
//        {"~CITAS MÉDICAS~"},
//        {"Ver Citas", "Programar Cita"},
//        {"~HISTORIAL MÉDICO~"},
//        {"Ver Historia Clínica", "Resultados de Exámenes"},
//        {"Logout"}
//    };
    ...
    private final String headerName = "Hospital";
